...
return [
    ...
    "mailbox" => "Buzón",
    "products" => "productos",
    "producDetails" => "Detalles de producto",
    ...
    "supprtickets" => "Tickets de soporte",
    "tickedetails" => "Detalles del billete",
    "layouts" => "Diseños",
    ...
    "walleconnect" => "Monedero Conectar",
    "create-nft" => "Crear NFT",
    "one-page" => "Una página",
    "nflanding" => "Aterrizaje NFT",
    "landing" => "Aterrizaje",
