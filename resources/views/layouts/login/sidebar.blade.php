...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="{{route('dashboard', [app()->getLocale()])}}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{asset('assets/login/images/logo-sm2.png')}}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{asset('assets/login/images/logo-lightdark.png')}}" alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="{{route('dashboard', [app()->getLocale()])}}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{asset('assets/login/images/logo-sm2.png')}}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{asset('assets/login/images/logo-light.png')}}" alt="" height="25">
            </span>
        </a>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="dashboard-analytics.php" class="nav-link" data-key="t-analytics"> Overview </a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-crm.php" class="nav-link" data-key="t-crm"> Performance </a>
                            </li>
                            <li class="nav-item">
                                <a href="index.php" class="nav-link" data-key="t-ecommerce"> Risks </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">My Programs</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Shared Programs</span> <span class="badge badge-pill bg-danger" data-key="t-hot">Hot</span>
                    </a>
