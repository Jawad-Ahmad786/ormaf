                                        ...
                                        <div class="card-body p-4 m-2">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-1 fw-semibold">Basic</h5>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="#" class="btn btn-success w-100 waves-effect waves-light">Select</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card pricing-box ribbon-box right">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fw-semibold">Professional</h5>
                                                        <small class="text-success">For Teams</small>
                                                    </div>
                                                    <div class="avatar-sm">
                                                        <div class="avatar-title bg-light rounded-circle text-primary">
                                                ...
                                                <div class="pt-4">
                                                    <h2><sup><small>$</small></sup> 50.00<span class="fs-13 text-muted">/Month</span></h2>
                                                </div>
                                            </div>
                                            <hr class="my-4 text-muted">
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="#" class="btn btn-soft-success w-100 waves-effect waves-light">Select</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            <div>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fw-semibold">Enterprise Plan</h5>
                                                        <small class="text-success">For Multi-Depts</small>
                                                    </div>
                                                    <div class="avatar-sm">
                                                        <div class="avatar-title bg-light rounded-circle text-primary">
                                                ...
                                                <div class="pt-4">
                                                    <h2><sup><small>$</small></sup> 100.00<span class="fs-13 text-muted">/Month</span></h2>
                                                </div>
                                            </div>
                                            <hr class="my-4 text-muted">
                                            <div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <ul class="list-group mb-3">
													...
													<div class="d-flex align-items-start gap-3 mt-4">
														<a href="{{route('subscriptions.info', ['locale' => app()->getLocale()])}}"><button type="button" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-bill-address-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Checkout</button></a>
													</div>
                                            </div>
                                        </div>
                                        <!-- end row -->
