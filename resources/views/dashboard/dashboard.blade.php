...
@section('content')
    ...
    <link href="{{asset('assets/login/libs/jsvectormap/css/jsvectormap.min.css')}}" rel="stylesheet" type="text/css" />
     <link href="{{asset('assets/login/libs/swiper/swiper-bundle.min.css')}}" rel="stylesheet" />
    @endpush
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col">
									...
									<div class="col-12">
										<div class="d-flex align-items-lg-center flex-lg-row flex-column">
											<div class="flex-grow-1">
												{{-- <h4 class="fs-16 mb-1"><img src="images/base.gif" width="19" height="16" align="absmiddle" /> <?php if(isset($allDetails[0]['department_name'])){echo $allDetails[0]['department_name']; } ?>
                            <?php
                            if( $_SESSION['security']['categoryID']==3)
                            {
                                ?>
                                <a href="#side_tree_dept-box" class="side_tree_dept-window"><span class="message_orange">Change</span></a>
                                <?php
                            }
                            ?></h4> --}}
												<p class="text-muted mb-0">Here's what's happening with your programs today.</p>
											</div>
											<div class="mt-3 mt-lg-0">
												<form action="javascript:void(0);">
													<div class="row g-3 mb-0 align-items-center">
														...
														<!--end col-->
														<div class="col-auto">
															<button type="button" class="btn btn-soft-success"><i class="ri-add-circle-line align-middle me-1"></i> Add Program</button>
														</div>
														<!--end col-->
														<div class="col-auto">
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-end justify-content-between mt-4">
													<div>
														...
														<a href="" class="text-decoration-underline">View all programs</a>
													</div>
									...
									<div class="col-xl-3 col-md-6">
										...
										<div class="card card-animate">
											<div class="card-body">
												<div class="d-flex align-items-center">
													<div class="flex-grow-1 overflow-hidden">
													 <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Performance</p>
													</div>
													<div class="flex-shrink-0">
                            ...
                            if(pms_module){?><td width="4%" align="center" valign="middle"><a href="pms/pmlm.php?dep_id=<?php echo $department_id;?>"><img src='images/lm.png' title='Logic Model' width='22' height='22' border='0' /></a></td><td width="4%" align="center" valign="middle"><a href="pms/pmdashboard.php?dep_id=<?php echo $department_id;?>"><img src='images/stats.png' title='Performance Dashboard' width='22' height='22' style='border-style: none'/></a></td><?php }
									...
									<div class="col-xl-3 col-md-6">
										...
										<div class="card card-animate">
											<div class="card-body">
												<div class="d-flex align-items-center">
													<div class="flex-grow-1 overflow-hidden">
														<p class="text-uppercase fw-medium text-muted text-truncate mb-0">Key Risk Areas</p>
													</div>
													<div class="flex-shrink-0">
														<h5 class="text-success fs-14 mb-0">
                            ...
                            if(rm_module){?><td width="4%" align="center" valign="middle"><a href="rm/rmdashboard.php?dep_id=<?php echo $department_id;?>"><img src='images/sc_icon.gif' title='Risk Dashboard' width='25' height='25' style='border-style: none'/></a></td><?php }
									...
									<div class="col-xl-3 col-md-6">
										...
										<div class="card card-animate">
											<div class="card-body">
												<div class="d-flex align-items-center">
													<div class="flex-grow-1 overflow-hidden">
														<p class="text-uppercase fw-medium text-muted text-truncate mb-0"> My Team</p>
													</div>
													<div class="flex-shrink-0">
													...
													<div class="avatar-group flex-nowrap">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{asset('assets/login/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{asset('assets/login/images/users/avatar-2.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{asset('assets/login/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                                                </a>
                                                            </div>
                                                        </div>
														<h4 class="fs-22 fw-semibold ff-secondary mb-4"></h4>
														<a href="team.php" class="text-decoration-underline">Team Members</a>
													</div>



    {{--<?php
        if(!pms_free_trial||!rm_free_trial)
        {
            $userOb = new classUser;
            $paaData = $userOb->getUserPaaSettings($department_id,0,0,0);
            $paa_id_for_dep = $paaData[0]['paa_id'];
        }
    ?>
--}}
                                <!--<a href="#add-groupmember-box" class="add-groupmember-window">-->
                                {{-- <a href="<?php echo $_SERVER['REQUEST_URI'].$urlRewriting;?>add_group_member=<?php echo $paa_id_for_dep; ?>" class="add-groupmember-window"> --}}
                                <div class="avatar-sm flex-shrink-0">
                            ...
                            {
                                ?><img src='images/group_disable.png' title='Add Group Member - Not available in Free Trial version!' border='0'/><?php
                            }
                            ...
                            ?> --}}
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-height-100">
                                                <div class="card-header align-items-center d-flex">
                                                    <h4 class="card-title mb-0 flex-grow-1">Projects by Locations</h4>
                                                    <div class="flex-shrink-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="px-2 py-2 mt-1">
                                                        ...
                                                        <p class="mt-3 mb-1">US <span class="float-end">82%</span></p>
                                                        <div class="progress mt-2" style="height: 6px;">
								...
								<div class="row">
									<div class="col-xl-4">
										<div class="card card-height-100">
											<div class="card-header align-items-center d-flex">
												<h4 class="card-title mb-0 flex-grow-1">Performance by Project Areas</h4>
												<div class="flex-shrink-0">
														...
														<tbody>
																...
																<td>
																	<div class="d-flex align-items-center">
																		<div class="flex-shrink-0 me-2">
																			<img src="{{asset('assets/login/images/users/avatar-1.jpg')}}" alt="" class="avatar-xs rounded-circle" />
																		</div>
															...
															<tr>
																...
																<td>
																	<div class="d-flex align-items-center">
																		<div class="flex-shrink-0 me-2">
																			<img src="{{asset('assets/login/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-circle" />
																		</div>
															...
															<tr>
																...
																<td>
																	<div class="d-flex align-items-center">
																		<div class="flex-shrink-0 me-2">
																			<img src="{{asset('assets/login/images/users/avatar-3.jpg')}}" alt="" class="avatar-xs rounded-circle" />
																		</div>
															...
															<tr>
																...
																<td>
																	<div class="d-flex align-items-center">
																		<div class="flex-shrink-0 me-2">
																			<img src="{{asset('assets/login/images/users/avatar-4.jpg')}}" alt="" class="avatar-xs rounded-circle" />
																		</div>
															...
															<tr>
																...
																<td>
																	<div class="d-flex align-items-center">
																		<div class="flex-shrink-0 me-2">
																			<img src="{{asset('assets/login/images/users/avatar-6.jpg')}}" alt="" class="avatar-xs rounded-circle" />
																		</div>
									...
									<div class="card-body p-0">
										...
										<div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
											<div class="acitivity-timeline acitivity-main">
													...
													<div class="flex-grow-1 ms-3">
														...
														<div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
															<a href="apps-ecommerce-product-details.php" class="bg-light rounded p-1">
																<img src="{{asset('assets/login/images/products/img-8.png')}}" alt="" class="img-fluid d-block" />
															</a>
															<a href="apps-ecommerce-product-details.php" class="bg-light rounded p-1">
																<img src="{{asset('assets/login/images/products/img-2.png')}}" alt="" class="img-fluid d-block" />
															</a>
															<a href="apps-ecommerce-product-details.php" class="bg-light rounded p-1">
																<img src="{{asset('assets/login/images/products/img-10.png')}}" alt="" class="img-fluid d-block" />
															</a>
														</div>
												...
												<div class="acitivity-item py-3 d-flex">
													<div class="flex-shrink-0">
														<img src="{{asset('assets/login/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
													</div>
													<div class="flex-grow-1 ms-3">
												...
												<div class="acitivity-item d-flex">
													<div class="flex-shrink-0">
														<img src="{{asset('assets/login/images/users/avatar-3.jpg')}}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
													</div>
													<div class="flex-grow-1 ms-3">
																...
																<div class="d-flex">
																	<div class="flex-shrink-0 avatar-sm">
																		<div class="avatar-title bg-light rounded">
																			<img src="{{asset('assets/login/images/companies/img-1.png')}}" alt="" height="30">
																		</div>
																	</div>
																	<div class="flex-grow-1 ms-3">
																		<div>
													...
													<div class="swiper-slide">
														<div class="card border border-dashed shadow-none">
															<div class="card-body">
																<div class="d-flex">
																	<div class="flex-shrink-0">
																		<img src="{{asset('assets/login/images/users/avatar-3.jpg')}}" alt="" class="avatar-sm rounded">
																	</div>
																	<div class="flex-grow-1 ms-3">
																		<div>
														...
														<div class="card border border-dashed shadow-none">
															<div class="card-body">
																<div class="d-flex">
																	<div class="flex-shrink-0 avatar-sm">
																		<div class="avatar-title bg-light rounded">
																			<img src="{{asset('assets/login/images/companies/img-8.png')}}" alt="" height="30">
																		</div>
																	</div>
																	<div class="flex-grow-1 ms-3">
																		<div>
													...
													<div class="swiper-slide">
														<div class="card border border-dashed shadow-none">
															<div class="card-body">
																<div class="d-flex">
																	<div class="flex-shrink-0">
																		<img src="{{asset('assets/login/images/users/avatar-2.jpg')}}" alt="" class="avatar-sm rounded">
																	</div>
																	<div class="flex-grow-1 ms-3">
																		<div>
										...
										<div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
											<div class="card-body">
												<img src="{{asset('assets/login/images/giftbox.png')}}" alt="">
												<div class="mt-4">
...
@endsection
    ...
    <!-- Swiper Js -->
    <script src="{{asset('assets/login/libs/swiper/swiper-bundle.min.js')}}"></script>

    <!-- CRM js -->
    <script src="{{asset('assets/login/js/pages/dashboard-crypto.init.js')}}"></script>
    ...
    <script src="{{asset('assets/login/js/app.js')}}"></script>
        ...
        <!-- Dashboard init -->
        <script src="{{asset('assets/login/js/pages/dashboard-ecommerce.init.js')}}"></script>
