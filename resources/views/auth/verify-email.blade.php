                                ...
                                <div class="p-2 mt-4">
                                    <div class="text-muted text-center mb-4 mx-lg-3">
                                       <h1>Email Verification Required</h1>
                                        ...
                                        <p>If you haven't received email. Please click on below button to resend link</p>
                                    </div>

                                   <form action="{{ route('verification.resend') }}" method="POST">
                                    @csrf
                                      <button type="submit" class="btn btn-primary mx-5">Resend Verification Email</button>
                                  </form>
