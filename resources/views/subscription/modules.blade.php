                                                ...
                                                <ul class="list-group mb-3">
                                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                                        <div>
                                                            ...
                                                            <small class="text-success">Remove</small>
                                                        </div>
													...
													<div class="d-flex align-items-start gap-3 mt-4">
														<a href="{{route('subscriptions.plans',['locale' => app()->getLocale()])}}"><button type="button" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-bill-address-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Continue</button></a>
													</div>
                                            </div>
                                        </div>
                                        <!-- end row -->
