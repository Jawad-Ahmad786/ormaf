...
return [
    ...
    "supprtickets" => "تذاكر الدعم الفني",
    "tickedetails" => "تفاصيل التذكرة",
    "nfmarketplace" => "سوق NFT",
    "marketplace" => "المتجر",
